...
#   define EMOSTATE_DLL_API extern
    ...
    */
    EMOSTATE_DLL_API EE_EEG_ContactQuality_t ES_GetContactQuality(
        EmoStateHandle state, int electroIdx);
    ...
    */
    EMOSTATE_DLL_API int ES_GetContactQualityFromAllChannels(EmoStateHandle state,
            EE_EEG_ContactQuality_t * contactQuality, size_t numChannels);
    ...
    */
    EMOSTATE_DLL_API void ES_ExpressivGetEyelidState(EmoStateHandle state,
    ...
    */
    EMOSTATE_DLL_API void ES_ExpressivGetEyeLocation(EmoStateHandle state,
            float * x, float * y);
    ...
    */
    EMOSTATE_DLL_API EE_ExpressivAlgo_t ES_ExpressivGetUpperFaceAction(
    ...
    */
    EMOSTATE_DLL_API float ES_ExpressivGetUpperFaceActionPower(
        EmoStateHandle state);
    ...
    */
    EMOSTATE_DLL_API EE_ExpressivAlgo_t ES_ExpressivGetLowerFaceAction(
        EmoStateHandle state);
    ...
    */
    EMOSTATE_DLL_API float ES_ExpressivGetLowerFaceActionPower(
        EmoStateHandle state);
    ...
    */
    EMOSTATE_DLL_API int ES_ExpressivIsActive(EmoStateHandle state,
    ...
    */
    EMOSTATE_DLL_API EE_CognitivAction_t ES_CognitivGetCurrentAction(
        EmoStateHandle state);
    ...
    */
    EMOSTATE_DLL_API EE_SignalStrength_t ES_GetWirelessSignalStatus(
        EmoStateHandle state);
    ...
    */
    EMOSTATE_DLL_API void ES_GetBatteryChargeLevel(EmoStateHandle state,
            int * chargeLevel, int * maxChargeLevel);
